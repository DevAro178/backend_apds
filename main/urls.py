...
from .views import (
    ...
    CategoryViewSet, LinksViewSet, ReportAttributesViewSet, SpamClassifierView, LoginView,LogoutView
)
...
router.register(r'report-attributes', ReportAttributesViewSet, basename='report-attributes')
